      ...
      <div className="container services__container">
        <article className="service">
          ...
          <ul className="service__list">
            ...
            copyright, database rights, and other intellectual property rights related to it, still belong to Maquito.

            Maquito is committed to ensuring that the app is as useful and efficient as possible.
            ...
            The Bot SecureSoft app stores and processes personal data that you have provided to us, to provide our Service.
            ...
            the official operating system of your device. It could make your phone vulnerable
            to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that
            the Bot SecureSoft app won’t work properly or at all.
            ...
            You should be aware that there are certain things that Maquito will not take responsibility for.
            Certain functions of the app will require the app to have an active internet connection.
            The connection can be Wi-Fi or provided by your mobile network provider, but Maquito cannot take responsibility
            for the app not working at full functionality if you don’t have access to Wi-Fi, and you don’t have any of your data
            allowance left.
            ...
            In using the app, you’re accepting responsibility for any such charges, including roaming data charges if
            you use the app outside of your home territory (i.e. region or country) without turning off data roaming.
            ...
            Along the same lines, Maquito cannot always take responsibility for the way you use the app i.e.
            You need to make sure that your device stays charged – if it runs out of battery and you can’t turn
            it on to avail the Service, Maquito cannot accept responsibility.


            With respect to Maquito’s responsibility for your use of the app, when you’re using the app,
            it’s important to bear in mind that although we endeavor to ensure that it is updated and correct at all times,
            we do rely on third parties to provide information to us so that we can make it available to you. Maquito accepts
            no liability for any loss, direct or indirect, you experience as a result of relying wholly on this functionality of the app.

            At some point, we may wish to update the app. The app is currently available on Android
            – the requirements for the system(and for any additional systems we decide to extend the availability
            of the app to) may change, and you’ll need to download the updates if you want to keep using the app.
            Maquito does not promise that it will always update the app so that it is relevant to you and/or works
            ...
            These terms and conditions are effective as of 2023-11-01
